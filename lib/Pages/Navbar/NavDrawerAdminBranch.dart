...
class NavDrawerAdminBranch extends StatefulWidget {
  @override
  _NavDrawerAdminBranch createState() => _NavDrawerAdminBranch();
}

class _NavDrawerAdminBranch extends State<NavDrawerAdminBranch> {
  @override
  void initState() {
