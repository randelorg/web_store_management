...
class LocalProductHistory extends StatefulWidget {
  final String? borrowerId, borrowerName;
  LocalProductHistory({this.borrowerId, this.borrowerName});

  @override
  _LocalProductHistory createState() => _LocalProductHistory();
}

class _LocalProductHistory extends State<LocalProductHistory> {
  var history = HistoryOperation();
  late Future productHistory;

  @override
  void initState() {
    super.initState();
    productHistory = history.viewLoanHistory(widget.borrowerId.toString());
  }
