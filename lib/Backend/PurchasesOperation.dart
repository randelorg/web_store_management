...
class PurchasesOperation {
    ...
    for (var item in Mapping.purchases) {
      try {
        ...
        await Environment.methodPost(
                "${Environment.apiUrl}/addpurchase", payload)
            .then((value) {
          response = value;
        });
      } catch (e) {
  ...
  Future<bool> markAsRecieved(String poId) async {
    ...
    try {
      await Environment.methodGet(
              "${Environment.apiUrl}/api/purchaseStatus/$poId/$status")
          .then((value) {
        response = value;
      });
  ...
  Future<List<IncomingPurchasesModel>> getOrders(
    ...
    try {
      await Environment.methodGet(
              "${Environment.apiUrl}/api/incomingpurchases/$orderId/$suppName/$date")
          .then((value) {
        response = value;
      });
  ...
  Future<List<IncomingPurchasesModel>> getProductItems(String barcode) async {
    ...
    try {
      await Environment.methodGet(
              "${Environment.apiUrl}/api/item/$barcode/$receive")
          .then((value) {
        response = value;
      });
  ...
  Future<bool> customerPurchase(String invoiceNumber) async {
    ...
    for (var item in Mapping.invoice) {
      ...
      try {
        ...
        await Environment.methodPost(
                "${Environment.apiUrl}/api/buyitem", payload)
            .then((value) {
          response = value;
        });
      } catch (e) {
  ...
  Future<bool> receivedItems() async {
    ...
    for (var item in Mapping.receiverOrders) {
      ...
      try {
        ...
        await Environment.methodPost(
                "${Environment.apiUrl}/api/additem", payload)
            .then((value) {
          response = value;
        });
      } catch (e) {
    ...
    try {
      ...
      await Environment.methodPost(
              "${Environment.apiUrl}/api/onhandreceive", payload)
          .then((value) {
        response = value;
      });
    } catch (e) {
