...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.dynamsoft.flutter_barcode_sdk.FlutterBarcodeSdkPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_barcode_sdk, com.dynamsoft.flutter_barcode_sdk.FlutterBarcodeSdkPlugin", e);
    }
    try {
